                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <p className="font-medium text-slate-900">
                          {p.pessoa?.nome_completo || p.nome_completo || 'Sem nome'}
                        </p>
                        {(p.pessoa?.email || p.email_enviado_para) && (
                          <p className="text-sm text-slate-600">{p.pessoa?.email || p.email_enviado_para}</p>
                        )}
                        {p.pessoa?.telefone && (
                          <p className="text-xs text-slate-500">{p.pessoa.telefone}</p>
                        )}
                      </div>
                      <span
                      ...
                      >
                        {(p.confirmacao_presenca || 'pendente').charAt(0).toUpperCase() + 
                         (p.confirmacao_presenca || 'pendente').slice(1)}
                      </span>
                    </div>
                  </div>
                ))}
